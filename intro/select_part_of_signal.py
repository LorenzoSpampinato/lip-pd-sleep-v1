...
n_campioni_5_percento = int(n_campioni_totali * 0.05)
...
percorso_output_fif = 'D:/TESI/lid-data-samples/lid-data-samples/Dataset/DYS/PD012_parziale.fif'
...
print(f"I primi 5% dei dati sono stati salvati con successo in {percorso_output_fif} e {percorso_output_bin}")
